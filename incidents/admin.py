...
class IncidentAdmin(admin.ModelAdmin):
    list_display = (
        "id", "incident_datetime", "location", "activity_type",
        "team", "primary_player", "treatment_level", "status",
        "submitted_to_eh",
    )
    list_filter = (
        "activity_type", "status", "treatment_level",
        "submitted_to_eh", "suspected_concussion", "age_under_18"
    )
