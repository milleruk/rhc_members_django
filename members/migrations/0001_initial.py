        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question_type",
                    models.CharField(
                        choices=[("text", "Text"), ("boolean", "Checkbox")],
                        default="text",
                        max_length=10,
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="viewable_questions", to="auth.group"
                    ),
                ),
                (
                    "applies_to",
                    models.ManyToManyField(related_name="questions", to="members.playertype"),
                ),
            ],
            options={
