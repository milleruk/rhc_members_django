...
class TaskAdmin(admin.ModelAdmin):
    ...
    list_filter = ("status", "complete_on", "allow_manual_complete", "assigned_to", "created_by", "subject_ct")
    ...
    def subject_link(self, obj):
        ...
        try:
            ...
            url = reverse(f"admin:{obj.subject_ct.app_label}_{obj.subject_ct.model}_change", args=[instance.pk])
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        try:
            ...
            form.base_fields["subject_ct"].queryset = ContentType.objects.filter(app_label__in=allowed_apps)
        except Exception:
            pass
        return form
